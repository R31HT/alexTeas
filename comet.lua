...
local romania = Instance.new("TextButton")
...
co.Position = UDim2.new(0.35, 0, 0.0103806229, 0)
co.Size = UDim2.new(0, 200, 0, 33)
co.Font = Enum.Font.SourceSansBold
co.Text = "C00LKIDD'S PA"
...
met.Position = UDim2.new(0.70, 0, 0.0103805698, 0) -- Adjusted X value
met.Size = UDim2.new(0, 100, 0, 33)
met.Font = Enum.Font.SourceSansBold
met.Text = "NEL"
met.TextColor3 = Color3.fromRGB(255, 0, 0)
met.TextSize = 36.000
met.TextWrapped = true
...
TextLabel.Text = "Bootleg Secret Sevice Panel"
...
romania.Parent = Scroller
romania.BackgroundColor3 = Color3.fromRGB(102, 0, 255)
romania.BackgroundTransparency = 0.300
romania.BorderSizePixel = 0
romania.Position = UDim2.new(Stools.Position.X.Scale + Stools.Size.X.Scale, Stools.Position.X.Offset + Stools.Size.X.Offset + 10, Stools.Position.Y.Scale, Stools.Position.Y.Offset)
romania.Size = UDim2.new(0, 123, 0, 33)
romania.Font = Enum.Font.SourceSansBold
romania.Text = "Steal Tools"
romania.TextColor3 = Color3.fromRGB(255, 255, 255)
romania.TextSize = 18.00

UICorner_30.Parent =  romania

blockhead.Name = "blockhead"
blockhead.Parent = Scroller
blockhead.BackgroundColor3 = Color3.fromRGB(102, 0, 255)
blockhead.BackgroundTransparency = 0.300
blockhead.BorderSizePixel = 0
blockhead.Position = UDim2.new(romania.Position.X.Scale + romania.Size.X.Scale, romania.Position.X.Offset + romania.Size.X.Offset + 10, romania.Position.Y.Scale, romania.Position.Y.Offset)
blockhead.Size = UDim2.new(0, 123, 0, 33)
blockhead.Font = Enum.Font.SourceSansBold
blockhead.Text = "Blockhead"
blockhead.TextColor3 = Color3.fromRGB(255, 255, 255)
blockhead.TextSize = 18.00

UICorner_31.Parent = blockhead

gojo.Name = "gojo"
gojo.Parent = Scroller
gojo.BackgroundColor3 = Color3.fromRGB(102, 0, 255)
gojo.BackgroundTransparency = 0.300
gojo.BorderSizePixel = 0
gojo.Position = UDim2.new(Stools.Position.X.Scale, Stools.Position.X.Offset, 
Stools.Position.Y.Scale, Stools.Position.Y.Offset + Stools.Size.Y.Offset + 10)
gojo.Size = UDim2.new(0, 123, 0, 33)
gojo.Font = Enum.Font.SourceSansBold
gojo.Text = "Go/jo"
gojo.TextColor3 = Color3.fromRGB(255, 255, 255)
gojo.TextSize = 18.00

UICorner_32.Parent = gojo


shutdown.Name = "Shutdown"
shutdown.Parent = Scroller
shutdown.BackgroundColor3 = Color3.fromRGB(102, 0, 255)
shutdown.BackgroundTransparency = 0.300
shutdown.BorderSizePixel = 0
shutdown.Position = UDim2.new(gojo.Position.X.Scale + gojo.Size.X.Scale, gojo.Position.X.Offset + gojo.Size.X.Offset + 10, gojo.Position.Y.Scale, gojo.Position.Y.Offset)
shutdown.Size = UDim2.new(0, 123, 0, 33)
shutdown.Font = Enum.Font.SourceSansBold
shutdown.Text = "Server Shutdown"
shutdown.TextColor3 = Color3.fromRGB(255, 255, 255)
shutdown.TextSize = 18.00


UICorner_33.Parent = shutdown
...
Target.PlaceholderText = "Enter username here"
Target.Text = ""
...
local SpecialPlayerCases = {
	...
	["all except (.+)"] = function(speaker, args)
		local exceptNames = splitString(args[1], ",")
		local lowerExceptNames = {}
		for _, name in pairs(exceptNames) do
			table.insert(lowerExceptNames, string.lower(name))
		end
		...
		for i, v in pairs(Players:GetPlayers()) do
			...
			if v ~= speaker and not table.find(lowerExceptNames, lowerName) and not table.find(lowerExceptNames, lowerDisplayName) then
				table.insert(plrs, v)
			end
		end
		return plrs
...
Kill.MouseButton1Click:Connect(function()
	...
	for i, v in pairs(players) do
		if Players[v].Character:FindFirstChildOfClass("Humanoid").RigType == Enum.HumanoidRigType.R6 then
			Destroy(Players[v].Character.Torso)
		else
			Destroy(Players[v].Character.Head)
		end
	end
end)
...
Btools.MouseButton1Click:Connect(function()
    ...
    destroytool.ToolTip = ":troll: | C00LKIDD'S PANEL"
...
Stools.MouseButton1Click:connect(function()
	if slockk then 
		TextLabel.Text = "Reborn by c00lkidd PS: false"
		slockk = false
	else
		TextLabel.Text = "Join team C00LKIDD PS: true"
		slockk = true
	end
end)

romania.MouseButton1Click:connect(function()
	local players = getPlayer(Target.Text, Players.LocalPlayer)
	for i, v in pairs(players) do
		Destroy(Players[v].Character:FindFirstChildOfClass("Humanoid"))
...
gojo.MouseButton1Click:connect(function()
	local players = getPlayer(Target.Text, Players.LocalPlayer)
	for i,v in pairs(players) do
		if Players[v].Character:FindFirstChildOfClass("Humanoid").RigType == Enum.HumanoidRigType.R6 then
			Destroy(Players[v].Character["Left Leg"])
			...
			Destroy(Players[v].Character["LeftUpperLeg"])
			Destroy(Players[v].Character["LeftLowerLeg"])
			Destroy(Players[v].Character["RightUpperLeg"])
			Destroy(Players[v].Character["RightLowerLeg"])
			Destroy(Players[v].Character["RightFoot"])
			Destroy(Players[v].Character["LeftRoot"])
		end
	end
end)
